        ...
        <form className={styles.briefForm}>
          ...
          <div className={styles.competitors}>
            ...
            <label htmlFor="competitors">
              2.1. Прямые конкуренты <br />{" "}
              <span className={styles.smalltext}>
                Необходимо указать прямых конкурентов в Вашем ценновом сегменте.
                По возможности охарактеризуйте их сильные и слабые стороны.
          ...
          <div className={styles.customer}>
            ...
            <label htmlFor="customer">
              3.1. Покупатель продукта/услуги
              <br />{" "}
              <span className={styles.smalltext}>
                Кто принимает решение о покупке продукта или услуги? Его
                социально-демографические характеристики (пол, возраст, доход,
                образование, стиль жизни)
              </span>
            </label>
          ...
          <div className={styles.accent}>
            ...
            <label htmlFor="accent1">
              4.1. Что привело Вас к решению создать новый сайт (изменить
              существующий)?
            </label>
            <textarea id="accent1" type="text"></textarea>
            <label htmlFor="accent2">
              4.2. Какие основные задачи стоят перед разработчиком сайта?
            </label>
            <textarea id="accent2" type="text"></textarea>
            <label htmlFor="accent3">
              4.3. Напишите предварительную структуру сайта: основные разделы,
              подразделы. Кратко опишите их функциональное назначение и дайте
              характеристику содержания каждого из разделов.
            </label>
            <textarea id="accent3" type="text"></textarea>
            <label htmlFor="accent4">
              4.4. Какие материалы у Вас у есть?
              <span className={styles.smalltext}>
                Логотип, знак, фирменный цвет, фирменный шрифт, фотографии,
                материалы, используемые при разработке другой рекламной
                продукции и т. д.?
              </span>
            </label>
            <textarea id="accent4" type="text"></textarea>
            <label htmlFor="accent5">
              4.5. Желаемые сроки разработки сайта
            </label>
            <textarea id="accent5" type="text"></textarea>
            <label htmlFor="accent6">
              4.6. Бюджет проекта (возможны ориентировочные рамки от и до)
            </label>
          ...
          <div className={styles.requirement}>
            ...
            <label htmlFor="requirement1">
              5.1. Требования к дизайну{" "}
              <span className={styles.smalltext}>
                Напишите требования к дизайну, которые обязательны для
                исполнения. Пожелания к дизайну сайта.
              </span>
            </label>
            <textarea id="requirement1" type="text"></textarea>
            <label htmlFor="requirement2">
              5.2. Близкие к желаемому результату по стилю сайты других
              компаний?{" "}
              <span className={styles.smalltext}>
                Напишите адреса нескольких сайтов, которые Вам нравятся. Что
                именно Вам нравится в этих сайтах (стильный дизайн, удобная
                навигация и т. п.)?
              </span>
            </label>
          ...
          <div className={styles.another}>
            ...
            <label htmlFor="another">
              6.1. Любая полезная в работе над проектом информация
            </label>
